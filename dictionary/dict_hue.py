...
# prima c'è tutta la parte di search for all lights, discovery, con rispettive risposte
# ci sarebbe anche la parte di delete
settings = []
# facciamo che per ora ci sono solo le lights
