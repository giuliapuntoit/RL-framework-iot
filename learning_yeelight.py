...
from utility_yeelight import send_search_broadcast, bulbs_detection_loop, operate_on_bulb, operate_on_bulb_json, \
    ...
    def run(self):
        ...
        for episode in range(self.total_episodes):
            ...
            while t < self.max_steps:
                ...
                # TODO the function choose_action and update should be different for sarsa lambda and q-learning
                # just these 2??? maybe just self.update
                # i could pass a flag to these functions, in order to set the desired algorithm
...
if __name__ == '__main__':
    ...
    if len(bulb_idx2ip) == 0:
        ...
        optimalPolicy, obtainedReward = SarsaSimplified(max_steps=400, total_episodes=400, num_actions_to_use=15, algorithm='sarsa').run()
        if optimalPolicy:
            print("Optimal policy was found with final reward of ", obtainedReward)
        else:
            print("No optimal policy reached with final reward of ", obtainedReward)
